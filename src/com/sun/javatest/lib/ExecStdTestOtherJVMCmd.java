...
/**
 * This is a modification of {@code ProcessCommand} suitable
...
public class ExecStdTestOtherJVMCmd extends ProcessCommand {
     ...
     * {@code Status.failed("exit without status, exception assumed")}.
