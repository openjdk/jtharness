...
import com.sun.interview.wizard.selectiontree.selection.StyledSelectionElement;
...
public class SelectionTree extends JTree {
    ...
    private static final Icon selectedIcon = getIcon("selected.gif");
    private static final Icon unselectedIcon = getIcon("unselected.gif");
    private static final Icon partiallySelectedIcon = getIcon("partially.gif");
    ...
    private static Icon getIcon(String iconFileName) {
        try {
            return new ImageIcon(ImageIO.read(SelectionTree.class.getResourceAsStream("resources/" + iconFileName)));
        } catch (IOException e) {
            return null;
        }
    }
