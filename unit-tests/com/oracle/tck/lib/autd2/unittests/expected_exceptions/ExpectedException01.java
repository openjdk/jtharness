...
public class ExpectedException01 {
    ...
    public static class TestGroup02 implements IBase{
        static int testCaseMethodCalled;
    ...
    @Test
    public void oneTestCase_1() {
        TestGroup02.testCaseMethodCalled = 0;
        com.oracle.tck.lib.autd2.TestResult s = TU.runTestGroup(new TestGroup02(), TU.EMPTY_ARGV);
        Assert.assertTrue(s.isOK());
        Assert.assertEquals("test cases: 1; all passed", s.getMessage());
        Assert.assertEquals(1, TestGroup02.testCaseMethodCalled);
    }
