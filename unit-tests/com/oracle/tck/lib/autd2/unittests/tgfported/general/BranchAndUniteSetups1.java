 ...
 *
 */
public class BranchAndUniteSetups1 {
    ...
    public void test() {
        ...
        final BranchAndUniteSetups1.MyTestedInstance mock = mock(BranchAndUniteSetups1.MyTestedInstance.class);

        @TestGroup
        class MyTest  {

             Values setup1() {
                return DataFactory.createColumn((Object[])ROW_1);
            }
             Values setup2() {
