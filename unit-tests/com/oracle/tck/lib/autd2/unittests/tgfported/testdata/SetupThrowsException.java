 ...
 *
 */
public class SetupThrowsException extends junit.framework.TestCase {

    public void test() {

        SetupThrowsException._TestCase testCase = new SetupThrowsException._TestCase();

        com.oracle.tck.lib.autd2.TestResult status = TU.runTestGroup(testCase);

        assertFalse(testCase.isProperMethodWasCalled());
