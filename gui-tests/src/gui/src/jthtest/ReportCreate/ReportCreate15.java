...
/**
 * This test case verifies that selecting the Configuration Log, Standard
 * Values, Keyword Summary box will display a link to configuration of the test
 * run , a link to the results of the test run in the report.html.
 */
